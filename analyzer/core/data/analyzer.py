...
class Analyzer:
    ...
    def __init__(
        ...
        self._rtts_in_microseconds = rtts_in_microseconds
    ...
    def __eq__(self, other: Analyzer) -> bool:
        ...
        if are_equal:
            are_equal = (
                ...
                self.rtts_in_microseconds == other.rtts_in_microseconds
            )
        return are_equal
    ...
    @property
    def rtts_in_microseconds(self) -> List[int]:
        return self._rtts_in_microseconds
