...
// Ensure, that ServerMock does implement experimenter.Server.
// If this is not the case, regenerate this file with moq.
var _ experimenter.Server = &ServerMock{}

// ServerMock is a mock implementation of experimenter.Server.
//
//	func TestSomethingThatUsesServer(t *testing.T) {
//
//		// make and configure a mocked experimenter.Server
...
//		}
//
//		// use mockedServer in code that requires experimenter.Server
